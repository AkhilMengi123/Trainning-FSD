...
<br><br><br>
<form action="transfer" class="was-validated">
      <div class="form-group">
      <label for="uname">Enter the mobile number to transfer:</label>
      <input type="text" class="form-control" id="uname" placeholder="Enter Mobile number to transfer" name="transfer_mobile" required>
